...
from functions.utils import open_file_as_dataframe, save_dataframe_to_pkl, save_csv_pickle


df1 = open_file_as_dataframe(default_path = r'data\after_scraping.csv')
...
print(df8['land_surface'].isna().sum())
